...
from model import LinearClassifier, ThreeLayerPerceptron, MultiLayerPerceptron, CNN_mit, CNN_st
...
def select_model(model_name):
    models = {"linear": LinearClassifier, "3lp": ThreeLayerPerceptron,
              "mlp": MultiLayerPerceptron, "cnn_mit": CNN_mit, "cnn_st": CNN_st}
...
def make_optimizer(model, stepsize):
    ...
    optimizer.add_hook(chainer.optimizer.WeightDecay(0.00000005))
    return optimizer
